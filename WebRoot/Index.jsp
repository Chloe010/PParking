...
<body>
    ...
    <div class="wrap">
        <ul class="siderbar">
			...
			<li><span>车位</span>
				<ul>
					<a href="<%=path %>/Stop/stop.jsp" target="mainFrame">车位信息</a></br>
				</ul>
			</li>
        	<li><span>系统信息管理</span>
	        	<ul>
	        ...
	        <li><span>临时车辆停车管理</span>
	        	<ul>
					<li><a href="<%=path %>/Admin/TempAdd.jsp?type=4" target="mainFrame">车主出入场信息</a></li>
	                <li><a href="<%=path %>/TempHandle?type=4" target="mainFrame">车主出入场信息</a></li>
	        	</ul>
            </li>
			<li><span>停车场收益情况</span>
				<ul>
					<li><a href="<%=path %>/Admin/Profit.jsp" target="mainFrame">停车场收益情况</a></li>
				</ul>
			</li>
	        <li><span>系统功能操作</span>
	        	<ul>
			...
			%>
			<li>值班人员信息系统</li>
			<li><span>值班人员信息管理</span>
				<ul>
					<li><a href="<%=path %>/Stop/stop.jsp" target="mainFrame">车位信息</a></li>
					<li><a href="<%=path %>/Admin/Worker.jsp" target="mainFrame">车主出入场信息</a></li>
				</ul>
			</li>
			<li><span>系统功能操作</span>
				<ul>
			...
			<%
				...
				if(!session.getAttribute("role_id").toString().equals("r001") & !session.getAttribute("role_id").toString().equals("r002"))
				{
	        %>
			<li><span>普通用户信息管理</span>
				<ul>
					<li><a href="<%=path %>/Admin/SelfMsg.jsp" target="mainFrame">个人车位信息</a></li>
				</ul>
			</li>
			<li><span>系统功能操作</span>
				<ul>
   ...
   <div class="footer">
	   ...
	   <h1>
		   临时停车用户每小时5元收费，超过30分钟按1小时计，不足30分钟不计费，封顶一天40元；固定用户包月用户一个月500元.
	   </h1>
   </div>
</body>
</html>
